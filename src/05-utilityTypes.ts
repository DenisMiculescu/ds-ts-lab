...
import { Friend, Colleague, SecureFriendContact, FriendPartial, EventPass, friendColleagueInt } from "./myTypes";
...
function intersection(friends: Friend[], colleagues: Colleague[]): friendColleagueInt [] {

    let result: friendColleagueInt[] = []
    ...
    friends.reduce((res, friend) => {
        ...
        if (colleague) {
            const friendColleague: friendColleagueInt = {
                name: friend.name,
                age: friend.age,
                contact: {
